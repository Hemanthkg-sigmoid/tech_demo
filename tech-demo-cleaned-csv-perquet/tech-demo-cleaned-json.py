...
#added 1st line : import aws glue dynamicframe for converting to dataframe
...
#added 2nd line : predicate_pushdown for filtering based on region
predicate_pushdown = "region in ('ca','gb','us')"

datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "tech_demo_raw_data", table_name = "raw_statistics", transformation_ctx = "datasource0", push_down_predicate = predicate_pushdown)
...
#added 3rd line : import aws glue dynamicframe and partition keys for region
#MAKE SURE YOU COPY ONLY WHAT IS NEEDED

datasink1 = dropnullfields3.toDF().coalesce(1)
df_final_output = DynamicFrame.fromDF(datasink1, glueContext, "df_final_output")
datasink4 = glueContext.write_dynamic_frame.from_options(frame = df_final_output, connection_type = "s3", connection_options = {"path": "s3://tech-demo-cleansed-data/youtube/raw_statistics/", "partitionKeys": ["region"]}, format = "parquet", transformation_ctx = "datasink4")
